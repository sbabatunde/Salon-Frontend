...
export default function DeleteBlog({ isOpen, onClose, onConfirm, blog }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center" 
      ...
      <div className="bg-neutral-900 rounded-lg p-6 shadow-lg max-w-md w-full border border-yellow-600 animate-fade-in-up">
        <h2 className="text-xl font-semibold text-red-400 mb-4">Delete Blog Title -  <strong>{blog?.title}</strong></h2>
