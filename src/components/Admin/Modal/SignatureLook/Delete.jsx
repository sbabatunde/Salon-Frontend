export default function DeleteHeroVideo({ isOpen, onClose, onConfirm, picture }) {
    ...
    >
      ...
      <div className="bg-neutral-900 rounded-lg p-6 shadow-lg max-w-md w-full border border-yellow-600 animate-fade-in-up">
        <h2 className="text-xl font-semibold text-red-400 mb-4">
          Delete Hero Video - <strong>{picture?.title}</strong>
        </h2>
        <p className="text-yellow-200 mb-6">
          Are you sure you want to delete <strong>{picture?.title}</strong>? This action cannot be undone.
        </p>
