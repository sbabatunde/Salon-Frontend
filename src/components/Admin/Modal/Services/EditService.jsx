...
import { X, Save, Clock, Text, TextQuote, BadgeCheck, Search } from "lucide-react";
...
const ICON_NAMES = [
  ...
  "Home", "Music", "Phone", "Smile","CheckCircle", "XCircle", "AlertTriangle", "Info", "CheckSquare", "XSquare",
  "PlusCircle", "MinusCircle", "PlusSquare", "MinusSquare", "Eye", "EyeOff",
  "Lock", "Unlock", "User", "Users", "Settings","Flower", 
];
...
export default function EditService({ isOpen, onClose, service, onServiceUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await apiClient.put(`/services/update/${service.id}`, payload);
