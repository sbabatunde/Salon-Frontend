  ...
  const fetchDashboardData = async () => {
    ...
    try {
      const [
        ...
        apiClient.get(`/dashboard/revenue-chart?period=${activePeriod}`),
        apiClient.get('/dashboard/appointment-trends'),
        apiClient.get('/dashboard/service-performance'),
        apiClient.get('/dashboard/client-demographics')
      ]);
  ...
  return (
    <div className="p-4 md:p-6 bg-neutral-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        {/* Revenue Chart */}
        <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-2xl p-6 border border-yellow-700/30 shadow-xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-yellow-200/70 text-sm">Revenue vs Profit over time</p>
            </div>
        ...
        <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-2xl p-6 border border-blue-700/30 shadow-xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-blue-200/70 text-sm">Last 6 months performance</p>
            </div>
            <div className="text-blue-300 text-sm">
              Completion Rate: {appointmentTrends[appointmentTrends.length - 1]?.completion_rate || 0}%
            </div>
          </div>
        ...
        <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-2xl p-6 border border-green-700/30 shadow-xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-green-200/70 text-sm">Top performing services</p>
            </div>
            <div className="text-green-300 text-sm">
              Total Services: {servicePerformance.length}
            </div>
          </div>
        ...
        <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-2xl p-6 border border-purple-700/30 shadow-xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-purple-200/70 text-sm">Peak hours & preferences</p>
            </div>
            <div className="text-purple-300 text-sm">
              {clients.returning_clients || 0} Returning Clients
            </div>
          </div>
      ...
      {/* Financial Insights */}
      <div className="bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-2xl p-6 border border-emerald-700/30 shadow-xl mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-amber-900/20 p-5 rounded-xl border border-amber-700/30">
            <h3 className="text-lg font-semibold text-amber-200 mb-3">Business Health</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
